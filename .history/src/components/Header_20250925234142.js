  ...
  return (
    ...
    >
      ...
      <View style={styles.rightRow}>
        ...
        >
          <Ionicons name="person-circle-outline" size={26} color="#0A657E" />
        </Pressable>
        ...
        >
          <Ionicons name="cart-outline" size={26} color="#0A657E" />
        </Pressable>
      </View>
    </LinearGradient>
  );
...
const styles = StyleSheet.create({
  ...
  linkHover: { color: "#0A657E", fontWeight: "600" },
  underline: {
    marginTop: 2,
    height: 2,
    width: "100%",
