...
const styles = StyleSheet.create({
  ...
  column: {
    width: width - 40, // card width with margin
    backgroundColor: "#fff",
    borderRadius: 12,
    padding: 16,
    marginVertical: 10,
  ...
  applyBtn: { marginTop: 10, backgroundColor: "#0A657E", paddingVertical: 14, borderRadius: 30, alignItems: "center", marginBottom: 20 },
