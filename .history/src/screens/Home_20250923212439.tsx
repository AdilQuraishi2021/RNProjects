...
const heroImage = require('./assets/hero_bg.jpg'); // Your hero background image
const logoImage = require('./assets/aperture_logo.png'); // Your logo
const product1 = require('./assets/sliding_door.jpg');
const product2 = require('./assets/casement_window.jpg');
const product3 = require('./assets/french_door.jpg');
const reviewImage = require('./assets/client_review.jpg'); // Client review image
