...
const logoImage = { uri: 'https://i.imgur.com/yU4l2sH.png' };
...
const Home = () => {
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      {/* Scrollable Body */}
      <ScrollView showsVerticalScrollIndicator={false} style={styles.scrollableBody}>
        {/* Hero Section */}
        <ImageBackground source={heroImage} style={styles.heroSection}>
          <View style={styles.overlay}>
        ...
        <View style={styles.productsSection}>
          ...
          <View style={styles.productGrid}>
            <View style={styles.productItemCard}>
              ...
              <Text style={styles.productItemDescription}>A broad range of expertise, vast craft and professional caliber.</Text>
              <TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  footer: {
    ...
    paddingVertical: 30,
    paddingHorizontal: 20,
    zIndex: 10, // Ensure footer is on top
  },
  footerContent: {
    flexDirection: 'row',
    justifyContent: 'space-between',
