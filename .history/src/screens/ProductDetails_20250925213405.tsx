...
export default function ProductDetails() {
  // Get the params from the route, which contains the `product` object
  const route = useRoute();
  const { product } = route.params as ProductDetailsRouteParams; // Cast to the correct type
      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.content}>
          ...
          <View style={styles.specList}>
            <Text>• Frame Material: {product.material}</Text>
