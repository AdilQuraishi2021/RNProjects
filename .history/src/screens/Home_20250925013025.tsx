  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollInner}>
        ...
        {/* Type */}
        <FilterSection title="Type" options={["Sliding", "Casement"]} />

        {/* Material */}
        <FilterSection title="Material" options={["Aluminium", "Wood", "Vinyl"]} />

        {/* Size */}
        <FilterSection title="Size" options={["Standard", "Custom"]} />

        <TouchableOpacity style={styles.viewBtn} onPress={onViewResults}>
...
const styles = StyleSheet.create({
  ...
  logoImg: {
    ...
    height: 40,
    marginRight: 8, // spacing between image & text
  },
  logoText: {
    marginLeft: 30,
    fontSize: 22,
  ...
  link: { marginHorizontal: 30, fontSize: 16, color: "#444" },
  shopBtn: {
