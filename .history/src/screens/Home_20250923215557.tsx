...
// --- Online Image URLs ---
const heroImage = { uri: 'https://images.unsplash.com/photo-1549416568-19e0750bb862?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1740&q=80' };
const logoImage = { uri: 'https://i.imgur.com/KqB5D8L.png' }; // Placeholder logo (Aperture Architectural Solutions)
const slidingDoorImage = { uri: 'https://images.unsplash.com/photo-1596765103004-79350438b488?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1740&q=80' };
const casementWindowImage = { uri: 'https://images.unsplash.com/photo-1582234033100-2f3b7d1b3e1f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1740&q=80' };
const frenchDoorImage = { uri: 'https://images.unsplash.com/photo-1627447471862-2f0c76d29c42?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1740&q=80' };
const reviewProfileImage = { uri: 'https://randomuser.me/api/portraits/women/68.jpg' }; // Random user profile for review
const smallLogoImage = { uri: 'https://i.imgur.com/KqB5D8L.png' }; // Re-using main logo for small footers for simplicity
...
const styles = StyleSheet.create({
  ...
  navContainer: {
    flexDirection: 'row',
    width: '60%', // Adjust based on desired spacing
    justifyContent: 'space-between',
  },
  navText: {
    fontSize: 13,
  ...
  heroSection: {
    width: '100%',
    height: 380, // Slightly taller for better impact
    justifyContent: 'center',
    alignItems: 'center',
  },
  overlay: {
  ...
  heroContent: {
    paddingHorizontal: 20,
    width: '70%', // Adjust to match image width
  },
  heroTitle: {
    fontSize: 34,
    fontWeight: 'bold',
  ...
  benefitsSection: {
    ...
    borderRadius: 8,
    marginHorizontal: 20,
    marginTop: -50, // Pulls the section up over the hero image
    paddingVertical: 20,
    ...Platform.select({
      ios: {
        shadowColor: '#000',
  ...
  productsSection: {
    padding: 20,
    paddingTop: 30, // More space after benefits cards
    backgroundColor: Colors.lightGray,
  },
  sectionHeaderTitle: {
    fontSize: 18,
  ...
  productGrid: {
    flexDirection: 'row',
    justifyContent: 'space-between',
    flexWrap: 'wrap', // Allow items to wrap if needed, though 3 per row is fixed here
  },
  productItemCard: {
    width: (width - 60) / 3, // 3 items, 20px padding each side, 10px spacing between
    backgroundColor: Colors.white,
    borderRadius: 8,
    padding: 10,
    marginBottom: 20,
  ...
  quoteSection: {
    ...
    paddingHorizontal: 20,
    alignItems: 'center',
    marginHorizontal: 20, // To match image's floating box style
    borderRadius: 10,
    marginBottom: 30,
    ...Platform.select({
      ios: {
  ...
  footerCertLogos: {
    ...
    alignSelf: 'flex-start', // Align to the top of the footerContent row
    marginTop: 5,
  },
  certLogo: {
    width: 50,
    height: 50,
    marginLeft: 10,
    borderRadius: 5, // Slightly rounded for certificates
  },
});
