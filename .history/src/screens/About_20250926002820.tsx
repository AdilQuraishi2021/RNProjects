...
// ---- Local carousel images (keep using your asset paths) ----
...
// ---- Team data with remote images ----
const teamMembers = [
  {
    id: "1",
    name: "Alice",
    role: "Architect",
    img: { uri: "https://randomuser.me/api/portraits/women/44.jpg" },
  },
  {
    id: "2",
    name: "Bob",
    role: "Engineer",
    img: { uri: "https://randomuser.me/api/portraits/men/46.jpg" },
  },
  {
    id: "3",
    name: "Charlie",
    role: "Installer",
    img: { uri: "https://randomuser.me/api/portraits/men/32.jpg" },
  },
];
  ...
  useEffect(() => {
    const loop = () => {
      ...
      Animated.timing(translateX, {
        toValue: -teamWidth,
        duration: teamWidth * 100, // speed: bigger = slower
